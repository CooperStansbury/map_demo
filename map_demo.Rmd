...
This data was available from: https://www.kaggle.com/mikejohnsonjr/united-states-crime-rates-by-county/data with the following licesnse: CC0 1.0 Universal (CC0 1.0)

```{r Load Data}
df <- read.csv("crime_data_w_population_and_crime_rate.csv")
head(df)
```
